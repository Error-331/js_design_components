...
var _request_response_helpers = require('./../hapi/request_response_helpers');
...
var prepareHeaders = function prepareHeaders() {
    ...
    return (0, _ramda.reduce)(function (requestHeaders, requestHeader) {
        var headerName = (0, _ramda.keys)(requestHeader)[0];
...
var sendRequestToHapi = exports.sendRequestToHapi = function sendRequestToHapi(method, mode, path, headers, body) {
    return new Promise(function (resolve, reject) {
        sendRequest(method, mode, path, headers, body).then(function (_ref) {
            var response = _ref.response,
                data = _ref.data;
            return (0, _request_response_helpers.isHapiBoomError)(response.status, data) ? reject(data) : resolve({ response: response, data: data });
        }).catch(function (error) {
            return reject((0, _request_response_helpers.makeHapiBoomError)(error));
        });
    });
};
